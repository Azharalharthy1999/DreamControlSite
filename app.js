...
let remCounter = 0;
const REM_REQUIRED = 12; // Higher for no blue on gentle move
let calmCounter = 0;
const CALM_RESET = 5; // Fast reset to green
let varianceBuffer = [];
const VARIANCE_BUFFER_SIZE = 15; // Longer filter for noise
let calmVarianceAvg = localStorage.getItem('calmVarianceAvg') ? parseFloat(localStorage.getItem('calmVarianceAvg')) : 7;
let remSpikeThreshold = localStorage.getItem('remSpikeThreshold') ? parseFloat(localStorage.getItem('remSpikeThreshold')) : 1.0;
